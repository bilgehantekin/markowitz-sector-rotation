...
DEFAULT_RISK_AVERSION = 3.0  # Optimized: was 5.0 (comprehensive grid search)
DEFAULT_TILT_STRENGTH = 0.15
DEFAULT_MAX_WEIGHT = 0.20
DEFAULT_MIN_WEIGHT = 0.0
DEFAULT_SHRINK_FACTOR = 0.30
DEFAULT_TRANSACTION_COST_BPS = 10  # 0.1% = 10 basis points


DEFAULT_TECH_WEIGHT = 0.40  # Optimized: comprehensive grid search, Sharpe=2.057
DEFAULT_MACRO_WEIGHT = 0.60  # Optimized: comprehensive grid search, Sharpe=2.057
